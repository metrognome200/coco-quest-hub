...
import { Home, Trophy, Target, Coins } from "lucide-react";
...
const Navigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background border-t border-border p-4 sm:top-0 sm:bottom-auto">
